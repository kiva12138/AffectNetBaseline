...
manually_annotated_file_mount_json = r'/home/sh/AffectNet/train_mount.json'


weights_save_path = r'/home/sh/VSRemote/NetworkWithPytorch/AffectNet/CategoricalBaseLine/WeightedLoss/weights/net.pth'
log_dir = r'./logdir/'
